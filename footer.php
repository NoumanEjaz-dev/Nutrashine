            ...
            >
              <a href="index.html" class="navbar-brand">
                <h1 class="m-0 text-white">
                 <img src="img/team-nutrashine/dr.png" alt="dr" style="width: 200px; margin-top: -70px;"> 
              </a>

              <p class="mt-3 mb-4">Dr. Toushif Ahmed</p>
              <form action="">
            ...
            <div class="row gx-5">
              <div class="col-lg-4 col-md-12 pt-5 mb-5">
                ...
                <div class="d-flex mb-2">
                  ...
                  <p class="mb-0">Nutrashine</p>
                </div>

                <div class="d-flex mb-2">
                  <i class="bi bi-envelope-open text-primary me-2"></i>
                  <p class="mb-0">nutrashine@gmail.com</p>
                </div>
                <div class="d-flex mb-2">
                  <i class="bi bi-telephone text-primary me-2"></i>
                  <p class="mb-0">+092 345 67890</p>
                </div>
              </div>
              <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
                ...
                >
                  ...
                  >
                  <a class="text-light mb-2" href="#"
                    ><i class="bi bi-arrow-right text-primary me-2"></i>Team</a
                  >
                </div>
              </div>
              <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5">
            ...
            >
              <p class="mb-0">
                ...
                <a
                  ...
                  href="https://nomeedev.herokuapp.com/"
                  >noumanejazdev</a
                >
              </p>
            </div>
